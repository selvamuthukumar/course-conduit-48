          ...
          <div className="space-y-2">
            ...
            {showDetails && <div className="bg-muted/50 rounded-lg p-4 space-y-3 text-sm">
                ...
                <div>
                  ...
                  <a href={course.curriculumUrl || "https://nqr.gov.in/qualifications/2740"} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 underline transition-colors">
